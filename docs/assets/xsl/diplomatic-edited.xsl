...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                     ...
                     <div class="row">
                        ...
                        <div class='col-sm'>
                           <article class="transcription">
                              <xsl:apply-templates select="./tei:div[@rend='left column']"/>                                      
                           </article>
                        </div>
                        <div class='col-sm'>
                           <article class="transcription">
                              <xsl:apply-templates select="./tei:div[@rend='right column']"/>  
                           </article>
                        </div>
   ...
   <xsl:template match="tei:figDesc">
      <div class="section-with-border">
         <!-- apply matching templates for anything that was nested in tei:figDesc -->
         <xsl:apply-templates/>
      </div>
   </xsl:template>
